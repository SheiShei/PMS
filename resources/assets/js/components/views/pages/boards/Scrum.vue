            ...
            <div class="board-wrapper" v-if="board">
                ...
                <div class="board-header">
                    <div class="board-name">
                        <h4 class="" style=""><span class="fa fa-trello"></span>
                            &nbsp;{{ board.name }}
                        </h4>
                    </div>
                    ...
                    <div class="board-info">
                        <button @click="viewMemmod = !viewMemmod" class="btn btn-white btn-simple btn-xs">
                            <span class="fa fa-user-plus fa-xs"></span>
                            <span class="hidden-xs hidden-sm"> New Member</span>
                        </button>
                    </div>
                    <div class="board-info">
                        <a @click.prevent="vFS = !vFS" class="btn btn-white btn-simple btn-xs">
                            <span class="fa fa-"></span> {{ vFS ? 'Hide Closed Sprint' : 'Show Closed Sprint' }}</a>
                    </div>
                    <div class="board-info">
