    ...
    <transition name="fade">
        <div class="overlay" v-if="data">
            <div class="close-mod-btn">
                <router-link :to="{name: 'us_view', params: {us_id: this.$route.params.us_id, sprint_id: this.$route.params.sprint_id}}" class="btn btn-simple btn-just-icon btn-default"><i class="fa fa-close"></i></router-link>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-3 col-sm-3 text-right">
                                    <h4 class="nm-bottom">
                                        ...
                                        <span v-if="taskPermission.delete" class=""><a @click="dT" class="btn btn-simple btn-close" title="Delete This Task"><i class="fa fa-trash-o"></i></a></span>
                                    </h4>
                                </div>
                            </div>
