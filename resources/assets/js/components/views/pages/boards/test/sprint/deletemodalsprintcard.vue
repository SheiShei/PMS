            ...
            <div class="modal-dialog modal-small " style="margin: 5% auto">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="txt-bold">This task will be permanently deleted.</p>
                    ...
                    <div class="modal-footer text-center">
                        ...
                        <button @click="dTask" type="button" class="btn btn-sm btn-success btn-simple">Delete</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        dTask() {
            this.$store.dispatch('deleteSprintTask', {id:this.$route.params.cardid, board_id: this.$route.params.board_id})
                .then((response) => {
