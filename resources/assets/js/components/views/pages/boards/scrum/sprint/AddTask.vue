            ...
            <div class="newTaskForm" style="">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <router-link :to="{ name: 'sprint', params: {board_id: $route.params.board_id, sprint_id: this.$route.params.sprint_id}}" class="btn btn-simple btn-close"><i class="fa fa-close"></i></router-link> 
                    </div>
                </div>
                <br />
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <router-link :to="{ name: 'sprint', params: {board_id: $route.params.board_id, sprint_id: this.$route.params.sprint_id}}" type="button" class="btn btn-danger btn-block">Cancel</router-link>
                    </div>
                    <div class="col-md-6">
...
export default {
    ...
    methods: {
        ...
        addTask() {
            ...
            task.append('status',this.$route.params.status_id);
