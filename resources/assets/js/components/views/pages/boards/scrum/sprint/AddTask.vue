    ...
    <transition name="fade">            
        <div class="overlay">
            ...
            <div class="newTaskForm" style="">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <router-link :to="{ name: 'sprint', params: {board_id: $route.params.board_id, sprint_id: this.$route.params.sprint_id}}" class="btn btn-danger btn-block">Cancel</router-link>
                    </div>
                    <div class="col-md-6">
