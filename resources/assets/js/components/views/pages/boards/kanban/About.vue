                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="taskchart shadow bl-gray">
                            <h4><span class="fa fa-trello"></span> Kanban Board {{ board.name }} - Details <span class="pull-right"><button @click="$emit('close')" class="btn btn-xs btn-danger btn-simple"><span class="fa fa-times"></span></button></span> </h4>
