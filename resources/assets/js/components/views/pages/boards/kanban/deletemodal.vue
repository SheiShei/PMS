            ...
            <div class="modal-dialog modal-small " style="margin: 5% auto">
                <div class="modal-content">
                    ...
                    <div class="modal-footer text-center">
                        ...
                        <button @click="deleteTask" type="button" class="btn btn-sm btn-success btn-simple">Delete</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        deleteTask() {
            this.$store.dispatch('deleteTask', {id: this.$route.params.taskid, board_id: this.$route.params.board_id})
                .then(() => {
