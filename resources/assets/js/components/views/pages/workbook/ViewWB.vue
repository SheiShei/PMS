                        ...
                        <div class="taskchart shadow brl-gray">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="no-margin text-gray"><i>Reviewed by Luljettas on Jan 20, 2019</i></p>
                                </div>
                        ...
                        <div class="taskchart shadow">
                            <div class="row hidden-xs">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 text-center">
                                    <h6 class="txt-bold text-default">{{ currentSlide+1 }} of {{ images.length }}</h6>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-3 text-right">
                                    <button @click="nextSlide" :disabled="currentSlide === images.length-1" class="btn btn-default btn-sm">
                                        <!-- Next -->
                    ...
                    <div class="col-md-7">
                        <div class="taskchart shadow">
                            <p class="txt-bold">
                                    ...
                                    <p class="text-default">{{ getCurrentImage.acmaCaption}}</p>
                                    <hr/>
