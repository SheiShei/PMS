                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="btn-group bootstrap-select">
                                                        <select  required name="brandowner" class="selectpicker" data-style="btn btn-sm btn-info btn-simple" type="text">
                                                            <option disabled="" value="" selected="">--Select Brand--</option>
                                                            <option value="">Colgate, Inc.</option>
                                                        </select>
                                                    </div>
                                                </div>   
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" row="6" class="form-control" placeholder="Write something about this workbook..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-7" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <button class="btn btn-md btn-success">Save Workbook <span class="fa fa-check"></span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
